...
class _SignInScreenState extends State<SignInScreen> {
  ...
  void _checkUserDataAndNavigateScreen() async {
    ...
    var result = await _authController.signInWithUsernameAndPassword(_userNameController.text, _passwordController.text);
    SignInAccountState state = result['state'];

    switch (state) {
      case SignInAccountState.success:
        ...
        Get.offAllNamed(AppRoutes.navigationScreen);
        break;
      case SignInAccountState.notFound:
        setState(() {
          _isLoading = false;
        });
        Fluttertoast.showToast(
        ...
        break;
      case SignInAccountState.failed:
        setState(() {
          _isLoading = false;
        });
        Fluttertoast.showToast(
        ...
        break;
      case SignInAccountState.wrongPassword:
        setState(() {
          _isLoading = false;
        });
        Fluttertoast.showToast(
